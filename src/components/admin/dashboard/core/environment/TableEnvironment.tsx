...
const TableEnvieronment: React.FC<Props> = ({ environment, openModalFicha }) => {
    ...
    return (
        <div className="bg-base-100">
            <table className='table table-sm'>
                ...
                <tbody>
                    {
                        environment.map(item => <tr className='group' onClick={() => openModalFicha(item)}>
...
export default TableEnvieronment;