...
const CreateMenuPage: React.FC = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            if(result.error) {
                ...
                return toast.error(`Error temporal`)
            }
            const body = result.body as Menu;
            setData(body);
            console.log(body);
            setTags(body.tags);
            setAllergens(body.allergens);
    ...
    return !data ? <span>cargando</span> :  (
        <div className="min-h-screen bg-base-100">
            <NavbarAdmin />

            <div className="relative p-5 lg:px-10 bg-white mx-5 shadow mt-5">
                <h3 className="font-bold text-lg mb-4">Actualizar Menú</h3>
